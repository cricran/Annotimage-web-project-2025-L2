...
<?php ob_start() ?>
    <div id="content">
        ...
        <section id="login">
        <a href="<?= isset($_GET["callback"]) ? '/'.$_GET["callback"] : '/index.php' ?>"><img src="../static/images/close.svg" alt="close"></a>
        <h2>S'inscrire</h2>
            <p>Vous avez déjas un compte? <a href="/index.php/signin<?= '?callback=' . (isset($_GET['callback']) ? urlencode($_GET['callback']) : 'index.php'); ?>">se connecter</a></p>
